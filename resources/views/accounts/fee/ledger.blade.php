                    ...
                    <table class="table table-bordered text-center align-middle">
                        <thead class="table-light">
                            <tr>
                                <th>#</th>
                                <th>Semester/Year</th>
                                <th>Amount (₹)</th> is editable and then button to confirm and all fee stucture store in table (student_fee_structures)when it confirm then then ledger section is open  and payment is done by semester wise only not direclty
