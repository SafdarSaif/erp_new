                                ...
                                <div class="flex-shrink-0 text-end">
                                    <div class="d-flex align-items-end justify-content-end gap-3">
                                        <span class="text-success">
                                            ...
                                            {{-- {{ App\Models\Student::whereDate('created_at', '>=',
                        ...
                        <div class="card-body">
                            <div class="vstack gap-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                                    ...
                                    <span class="badge bg-success">{{ App\Models\Student::whereMonth('created_at',
                                        now()->month)->count() }}</span>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                                    ...
                                    <span class="badge bg-info">{{ \App\Models\Academics\Course::where('status',
                                        true)->count() }}</span>
                                </div>
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-12 col-md-12">
                                                    <div class="p-3 bg-light-subtle rounded d-flex flex-column">
                                                        <strong class="text-primary">{{ $department->name }}</strong>
                                                        <div class="mt-1 d-flex flex-wrap gap-1">
                                                            <span class="badge bg-warning">{{ $department->courses_count
                                                                ?? 0 }}
                                                                Courses</span>
                                                            <span class="badge bg-success">{{
                                                                $department->courses->sum('sub_courses_count') ?? 0 }}
                                                                Subcourses</span>
                                                            {{-- <span class="badge bg-secondary">{{
                                                                $department->courses->sum(fn($c) =>
                                                                $c->subCourses->sum('subjects_count')) ?? 0 }}
                                                                Subjects</span> --}}
                                                            <span class="badge bg-dark">{{ $departmentStudentCount }}
                                                                Students</span>
                                                        </div>
                                                    </div>
                                                </div>
