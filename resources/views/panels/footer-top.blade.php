...
{{-- <!-- JAVASCRIPT -->
    ...
    <!-- Datatable js -->
    <script src="assets/1.11.5/js/jquery.dataTables.min.js"></script>
    <script src="assets/1.11.5/js/dataTables.bootstrap5.min.js"></script>
    <script src="assets/responsive/2.4.0/js/dataTables.responsive.min.js"></script>
    <script src="assets/npm/jquery-datatables-checkboxes%401.3.0/js/dataTables.checkboxes.min.js"></script>
    <script src="assets/select/1.6.0/js/dataTables.select.min.js"></script>
    ...
    <script src="assets/js/dashboards/dashboard-ecommerce.init.js"></script>
