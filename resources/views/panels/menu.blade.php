                ...
                <div class="dropdown features-dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="dropdown-item">
                            <div class="hstack gap-2 overflow-hidden">
                                <div class="flex-shrink-0">
                                    <img class="img-fluid avatar-sm avatar-item" src="assets/images/avatar/avatar-1.jpg"
                                        alt="avatar image">
                                </div>
                                <div class="flex-grow-1 text-truncate">
                    ...
                    <div class="dropdown features-dropdown" id="language-dropdown">
                        <a href="#!" class="btn icon-btn btn-text-primary rounded-circle" data-bs-toggle="dropdown"
                            ...
                            <div class="avatar-item avatar-xs">
                                <img class="img-fluid avatar-xs" src="assets/images/flags/us.svg" loading="lazy"
                                    alt="avatar image">
                            </div>
                        </a>
                        ...
                        <div class="dropdown-menu header-language-scrollable dropdown-menu-end" data-simplebar="">
                            ...
                            <a href="#!" class="dropdown-item py-2">
                                <img src="assets/images/flags/us.svg" alt="en" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">English</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="assets/images/flags/es.svg" alt="es" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Spanish</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="assets/images/flags/fr.svg" alt="fr" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">French</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="assets/images/flags/ru.svg" alt="ru" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Russian</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="assets/images/flags/de.svg" alt="de" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">German</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="assets/images/flags/it.svg" alt="it" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Italian</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="assets/images/flags/zh.svg" alt="zh" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Chinese</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="assets/images/flags/ar.svg" alt="ar" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar-item avatar">
                                                <img class="img-fluid avatar" src="assets/images/avatar/avatar-9.jpg"
                                                    alt="avatar image">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li class="list-group-item list-group-item-action border-start-0 border-end-0">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3 position-relative">
                                            <div class="avatar-item avatar">
                                                <img class="img-fluid avatar" src="assets/images/avatar/avatar-6.jpg"
                                                    alt="avatar image">
                                            </div>
                                            <span
