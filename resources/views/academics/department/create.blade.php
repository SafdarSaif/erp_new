<div class="modal-body">
    <div class="text-center mb-3">
        <h3 class="mb-2 text-primary">Add Department</h3>
        <p class="text-muted">Fill in the department details below</p>
    </div>

    <form id="department-form" action="{{ route('department.store') }}" method="POST" class="row g-3">
        @csrf
