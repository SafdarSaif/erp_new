...
<div class="modal-body">
    ...
    <form id="userEditForm" action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="row g-3">
        @csrf
        @method('PUT')
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="name" id="name" value="{{ $user->name }}"
                   class="form-control" placeholder="Enter Name" oninput="createInitials()" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="tel" name="mobile" id="mobile" value="{{ $user->mobile }}" class="form-control" placeholder="Enter Mobile" required>
        </div>
