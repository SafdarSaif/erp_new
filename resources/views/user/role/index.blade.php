...
<main class="app-wrapper">
    <div class="app-container">
        ...
        <button
            onclick="add('{{ route('users.rolesReport.create', ['role_id' => $role->id]) }}', 'modal-lg')"
                ...
                <div class="card h-100">
                    <div class="row h-100 g-0">
                        <div class="col-sm-5 d-flex align-items-center justify-content-center">
                            <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" class="img-fluid"
                        ...
                        <div class="col-sm-7 d-flex align-items-center">
                            <div class="card-body text-center text-sm-end ps-sm-0">
                                ...
                                <div class="d-flex justify-content-sm-end gap-2 mb-2">
                                    <!-- Add New Role Button -->
                                    <button onclick="add('{{ route('users.roles.create') }}', 'modal-lg')"
                                ...
                                <p class="mb-0 small text-muted">Add role or manage hierarchy</p>
                            </div>
                        </div>
