<div class="modal-body">
    <div class="text-center mb-3">
        <h3 class="mb-2 text-primary">Add Language</h3>
        <p class="text-muted">Fill in the language details below</p>
    </div>

    <form id="language-form" action="{{ route('languages.store') }}" method="POST" class="row g-3">
        @csrf
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="short_name" id="short_name" class="form-control" placeholder="Enter short name (e.g. EN, HI)" required>
        </div>
