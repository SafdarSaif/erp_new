...
<script>
    $(function() {
      var canAdd = "{{ Auth::user()->hasPermissionTo('create academic years') ? true : false }}";
      const addButton = canAdd ? {
        text: 'Add Academic Year',
        className: 'add-new btn btn-primary mb-3 mb-md-0 waves-effect waves-light',
        attr: {
          'onclick': "add('{{ route('academicyears.create') }}', 'modal-lg')"
        },
        init: function(api, node, config) {
          $(node).removeClass('btn-secondary');
        }
      } : '';
      var canEdit = "{{ Auth::user()->hasPermissionTo('edit academic years') ? true : false }}";
      var table = $('#academic-year-table').DataTable({
        ajax: "{{ route('academicyears') }}",
        columns: [{
            data: 'DT_RowIndex'
          },
          {
          ...
          },
          {
            ...
            render: function(data, type, full, meta) {
              ...
              return `<div class="hstack gap-3">
                        ...
                        <button type="button" class="btn btn-light-danger border-danger icon-btn-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-white" data-bs-placement="top" data-bs-title="Delete" onclick="destry(&#39;/settings/academicyears/delete/${dataId}&#39;,&#39;academic-year-table&#39;)">
