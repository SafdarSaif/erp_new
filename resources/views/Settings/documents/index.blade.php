...
$(function() {
    ...
    const addButton = canAdd ? {
        ...
        attr: { 'onclick': "add('{{ route('document.create') }}', 'modal-lg')" }
    } : '';
        ...
        columnDefs: [
            {
                ...
                render: function(data, type, full) {
                    ...
                    var toggle = canEdit ? `onclick="updateActiveStatus('/settings/document/status/${full.id}', 'document-table')"` : 'onclick="return false;"';
            ...
            },
            {
                ...
                render: function(data, type, full) {
                    return `<div class="hstack gap-2 fs-15">
                                <button class="btn btn-sm btn-light-primary" onclick="edit('/settings/document/edit/${full.id}', 'modal-lg')">
                                    <i class="ri-pencil-line"></i>
                                </button>
                                <button class="btn btn-sm btn-light-danger delete-item" onclick="destry('/settings/document/delete/${full.id}', 'document-table')">
