...
class Student extends Model
{
    ...
    protected $fillable = [
        'academic_year_id', 'university_id', 'course_type_id', 'course_id', 'sub_course_id',
    ...
    public function university() { return $this->belongsTo(University::class, 'university_id'); }
    ...
    public function subCourse() { return $this->belongsTo(SubCourse::class, 'sub_course_id'); }
    public function mode() { return $this->belongsTo(AdmissionMode::class, 'admissionmode_id '); }
    public function courseMode() { return $this->belongsTo(CourseMode::class, 'course_mode_id'); }
